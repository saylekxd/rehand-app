  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
        ...
        {/* Basic Info */}
        <View style={styles.card}>
          <Text style={styles.cardTitle}>Podstawowe informacje</Text>
          ...
          <View style={styles.inputGroup}>
            ...
            <TouchableOpacity style={styles.dateInput} onPress={() => setShowDatePicker(true)}>
              <Text style={[styles.dateText, !profile.date_of_birth && styles.placeholder]}>
                {profile.date_of_birth || 'Wybierz datę'}
              </Text>
        ...
        <View style={styles.card}>
          <Text style={styles.cardTitle}>Płeć</Text>
          ...
          <Text style={[styles.cardTitle, { marginTop: 20 }]}>Poziom zaawansowania</Text>
        ...
        {/* Weekly Goal */}
        <View style={styles.card}>
          <Text style={styles.cardTitle}>Tygodniowy cel (minuty)</Text>
          <TextInput
            style={styles.input}
        ...
        {/* Goals */}
        <View style={styles.card}>
          <Text style={styles.cardTitle}>Cele treningowe</Text>
        ...
        {/* Medical Conditions */}
        <View style={styles.card}>
          <Text style={styles.cardTitle}>Uwagi medyczne</Text>
          <View style={styles.tagsContainer}>
